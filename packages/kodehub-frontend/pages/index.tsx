...
import frontend from '../public/static/frontend.png';
        ...
        <div className="flex flex-wrap -mx-2 py-4">
          <div className="lg:w-1/2 w-full px-2 mb-2 ">
            <Card
              img={frontend}
              title="Frontend"
              description="Find Something that you interested in"
              topics="3"
              lastTopic="Belajar React Typescript"
              Activity="2"
              User="100"
            />
          </div>
          <div className="lg:w-1/2 w-full px-2 mb-2">
            <Card
              ...
              topics="3"
              lastTopic="Trend Backend framework 2020"
              Activity="2"
              User="100"
            />
          </div>
          <div className="lg:w-1/2 w-full px-2 mb-2">
            <Card
              img={frontend}
              title="Lounge"
              description="Cakap sikit-sikit"
              topics="3"
              lastTopic="alur belajar untuk jago fullstack"
              Activity="2"
              User="100"
            />
          </div>
